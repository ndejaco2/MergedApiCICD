...
export interface BooksServiceStackProps extends cdk.StackProps {
}

export class BooksServiceStack extends cdk.Stack {
    private booksApi: IGraphqlApi;
    private booksDatasource: BaseDataSource;

    constructor(scope: Construct, id: string, props: BooksServiceStackProps) {
